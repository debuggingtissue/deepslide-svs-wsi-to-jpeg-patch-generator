...
def output_jpeg_tiles(full_image_path, full_output_path,
                      resolution_level):  # converts svs image with meta data into just the jpeg image
    ...
    print("converting", full_image_path, "with width", width, "and height", height)
...
parser.add_argument("-r", "--resolution_level", type=int, default=0,
                    help="Select resolution level for image to be split."
...
for image_name in image_names:
    ...
    output_jpeg_tiles(full_image_path, output_path, resolution_level)
